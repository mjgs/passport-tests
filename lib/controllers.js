const debug = require('debug')('lib:controllers'); // eslint-disable-line no-unused-vars
...
function profile(req, res) {
  // don't modify original, make a copy (needed because it's a fake db)
  const profileUser = Object.assign({}, req.session.user);
